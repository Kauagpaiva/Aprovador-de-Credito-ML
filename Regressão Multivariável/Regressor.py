...
dados = pd.read_csv(".\Dados\conjunto_de_treinamento.csv")
dados_teste = pd.read_csv(".\Dados\conjunto_de_teste.csv")
exemplo = pd.read_csv(".\Dados\exemplo_arquivo_respostas.csv")
